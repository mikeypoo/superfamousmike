<template>
  <div class="bonus">
    <div class="bonus-header">
      <h2>Oh, my! You found the secret part of my website D:</h2>
      <div>That means Mike told you to come here... or you're super good at guessing URLs.</div>
    </div>
